...
router.post("/addItemToCart", authenticate, cartController.addItemtoCart)

router.get('/findUserCart', authenticate, cartController.findUserCart)

router.delete('/deleteCartItem', authenticate, cartController.deleteCartItem)

router.put('/incremetItemInCart',authenticate,cartController.incremetItemInCart)

router.put('/decremetItemInCart',authenticate,cartController.decrementItemInCart)
